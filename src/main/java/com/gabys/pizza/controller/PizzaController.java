...
import com.gabys.pizza.service.PizzaService;
...
public class PizzaController {
    ...
    public ResponseEntity<List<PizzaEntity>> geWith(@PathVariable String ingredient) {
        return ResponseEntity.ok(this.pizzaService.getWith(ingredient));
    }

    @GetMapping("/without/{ingredient}")
    public ResponseEntity<List<PizzaEntity>> geWithout(@PathVariable String ingredient) {
